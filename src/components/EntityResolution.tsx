  ...
  return (
    <div className="w-full h-full bg-sutra-dark border border-white/10 flex flex-col overflow-hidden">
      ...
      <div className="p-4 border-t border-white/10 bg-sutra-surface flex gap-3">
        <button className="flex-1 py-3 border border-white/20 text-white text-[10px] font-bold uppercase tracking-widest hover:bg-white hover:text-black transition-colors flex items-center justify-center gap-2">
          <GitMerge className="w-3 h-3" /> Merge Profiles
        </button>
        <button className="flex-1 py-3 border border-white/5 text-sutra-silver-muted text-[10px] font-bold uppercase tracking-widest hover:text-white transition-colors flex items-center justify-center gap-2">
